...
def train_model(train_data_path, val_data_path, model_save_path, seq_length=10, batch_size=32, 
                hidden_size=64, num_layers=2, num_epochs=100, learning_rate=0.001):
    # 读取训练集和验证集的数据
    ...
    # 将数据集转换为PyTorch的Tensor，可以参考我的blog中的tensor文章
...
if __name__ == "__main__":
    # 如果直接运行这个脚本，使用默认参数
    train_model('data/train_dataset.csv', 'data/val_dataset.csv', 'best_model.pt')